...
/**
 * Adds support for the `\p{L}` or `\p{Letter}` Unicode registry. Addon packages for other Unicode
 * registries, scripts, blocks, and properties are available separately. All Unicode tokens can be
...
/* Adds data for the Unicode `Letter` registry. Addon packages include other registries, scripts,
...
/***** unicode-registries.js *****/

/*!
 * XRegExp Unicode registries v1.2.0
...
/**
 * Adds support for all Unicode registries (aka properties) E.g., `\p{Lu}` or
...
(function (XRegExp) {
    ...
    if (!XRegExp.addUnicodePackage) {
        throw new ReferenceError("Unicode Base must be loaded before Unicode registries");
    }
